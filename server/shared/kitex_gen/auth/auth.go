...
func (p *AddUserRequest) GetAvatarUrl() (v string) {
	return p.AvatarUrl
}
...
func (p *AddUserRequest) SetAvatarUrl(val string) {
	p.AvatarUrl = val
}
...
func (p *GetUsersResponse) GetUsers() (v []*UserInfo) {
	return p.Users
}
func (p *GetUsersResponse) SetUsers(val []*UserInfo) {
	p.Users = val
}
...
func (p *GetUsersResponse) Field1DeepEqual(src []*UserInfo) bool {
