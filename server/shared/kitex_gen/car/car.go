...
func (p *GetCarsResponse) ReadField2(iprot thrift.TProtocol) error {
	...
	_field := make([]*base.CarEntity, 0, size)
	values := make([]base.CarEntity, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
...
func (p *UpdateCarRequest) ReadField2(iprot thrift.TProtocol) error {
	...
	var _field base.CarStatus
	if v, err := iprot.ReadI32(); err != nil {
		return err
	} else {
		_field = base.CarStatus(v)
	}
	p.Status = _field
	return nil
}
func (p *UpdateCarRequest) ReadField3(iprot thrift.TProtocol) error {
	_field := base.NewPosition()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Position = _field
...
func (p *CarServiceAdminUpdateCarArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewAdminUpdateCarRequest()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Req = _field
...
func (p *CarServiceAdminUpdateCarResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewAdminUpdateCarResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
