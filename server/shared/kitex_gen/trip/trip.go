...
type EditTripRequest struct {
	TripEntity *TripEntity `thrift:"trip_entity,1" frugal:"1,default,TripEntity" json:"trip_entity"`
}

func NewEditTripRequest() *EditTripRequest {
	return &EditTripRequest{}
}

func (p *EditTripRequest) InitDefault() {
	*p = EditTripRequest{}
}

var EditTripRequest_TripEntity_DEFAULT *TripEntity

func (p *EditTripRequest) GetTripEntity() (v *TripEntity) {
	if !p.IsSetTripEntity() {
		return EditTripRequest_TripEntity_DEFAULT
	}
	return p.TripEntity
}
func (p *EditTripRequest) SetTripEntity(val *TripEntity) {
	p.TripEntity = val
}

var fieldIDToName_EditTripRequest = map[int16]string{
	1: "trip_entity",
}

func (p *EditTripRequest) IsSetTripEntity() bool {
	return p.TripEntity != nil
}

func (p *EditTripRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EditTripRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *EditTripRequest) ReadField1(iprot thrift.TProtocol) error {
	p.TripEntity = NewTripEntity()
	if err := p.TripEntity.Read(iprot); err != nil {
		return err
	}
...
func (p *EditTripRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("EditTripRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *EditTripRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("trip_entity", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.TripEntity.Write(oprot); err != nil {
		return err
...
func (p *EditTripRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EditTripRequest(%+v)", *p)
}

func (p *EditTripRequest) DeepEqual(ano *EditTripRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	}
	if !p.Field1DeepEqual(ano.TripEntity) {
		return false
	}
	return true
}

func (p *EditTripRequest) Field1DeepEqual(src *TripEntity) bool {
...
func NewEditTripResponse() *EditTripResponse {
	return &EditTripResponse{}
}

func (p *EditTripResponse) InitDefault() {
	*p = EditTripResponse{}
}

var EditTripResponse_BaseResp_DEFAULT *base.BaseResponse

func (p *EditTripResponse) GetBaseResp() (v *base.BaseResponse) {
	if !p.IsSetBaseResp() {
		return EditTripResponse_BaseResp_DEFAULT
	}
	return p.BaseResp
}
func (p *EditTripResponse) SetBaseResp(val *base.BaseResponse) {
	p.BaseResp = val
}

var fieldIDToName_EditTripResponse = map[int16]string{
	1: "base_resp",
}

func (p *EditTripResponse) IsSetBaseResp() bool {
	return p.BaseResp != nil
}

func (p *EditTripResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EditTripResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *EditTripResponse) ReadField1(iprot thrift.TProtocol) error {
	p.BaseResp = base.NewBaseResponse()
	if err := p.BaseResp.Read(iprot); err != nil {
		return err
	}
...
func (p *EditTripResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("EditTripResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *EditTripResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("base_resp", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.BaseResp.Write(oprot); err != nil {
...
func (p *EditTripResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EditTripResponse(%+v)", *p)
}

func (p *EditTripResponse) DeepEqual(ano *EditTripResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *EditTripResponse) Field1DeepEqual(src *base.BaseResponse) bool {
...
type TripService interface {
	...
	EditTrip(ctx context.Context, req *EditTripRequest) (r *EditTripResponse, err error)
...
func (p *TripServiceClient) EditTrip(ctx context.Context, req *EditTripRequest) (r *EditTripResponse, err error) {
	var _args TripServiceEditTripArgs
	_args.Req = req
	var _result TripServiceEditTripResult
	if err = p.Client_().Call(ctx, "EditTrip", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewTripServiceProcessor(handler TripService) *TripServiceProcessor {
	...
	self.AddToProcessorMap("EditTrip", &tripServiceProcessorEditTrip{handler: handler})
...
type tripServiceProcessorEditTrip struct {
	handler TripService
}

func (p *tripServiceProcessorEditTrip) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := TripServiceEditTripArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("EditTrip", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := TripServiceEditTripResult{}
	var retval *EditTripResponse
	if retval, err2 = p.handler.EditTrip(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing EditTrip: "+err2.Error())
		oprot.WriteMessageBegin("EditTrip", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("EditTrip", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type TripServiceEditTripArgs struct {
	Req *EditTripRequest `thrift:"req,1" frugal:"1,default,EditTripRequest" json:"req"`
}

func NewTripServiceEditTripArgs() *TripServiceEditTripArgs {
	return &TripServiceEditTripArgs{}
}

func (p *TripServiceEditTripArgs) InitDefault() {
	*p = TripServiceEditTripArgs{}
}

var TripServiceEditTripArgs_Req_DEFAULT *EditTripRequest

func (p *TripServiceEditTripArgs) GetReq() (v *EditTripRequest) {
	if !p.IsSetReq() {
		return TripServiceEditTripArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *TripServiceEditTripArgs) SetReq(val *EditTripRequest) {
	p.Req = val
}

var fieldIDToName_TripServiceEditTripArgs = map[int16]string{
	1: "req",
}

func (p *TripServiceEditTripArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *TripServiceEditTripArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TripServiceEditTripArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TripServiceEditTripArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewEditTripRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *TripServiceEditTripArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("EditTrip_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *TripServiceEditTripArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *TripServiceEditTripArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TripServiceEditTripArgs(%+v)", *p)
}

func (p *TripServiceEditTripArgs) DeepEqual(ano *TripServiceEditTripArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *TripServiceEditTripArgs) Field1DeepEqual(src *EditTripRequest) bool {
...
type TripServiceEditTripResult struct {
	Success *EditTripResponse `thrift:"success,0,optional" frugal:"0,optional,EditTripResponse" json:"success,omitempty"`
}

func NewTripServiceEditTripResult() *TripServiceEditTripResult {
	return &TripServiceEditTripResult{}
}

func (p *TripServiceEditTripResult) InitDefault() {
	*p = TripServiceEditTripResult{}
}

var TripServiceEditTripResult_Success_DEFAULT *EditTripResponse

func (p *TripServiceEditTripResult) GetSuccess() (v *EditTripResponse) {
	if !p.IsSetSuccess() {
		return TripServiceEditTripResult_Success_DEFAULT
	}
	return p.Success
}
func (p *TripServiceEditTripResult) SetSuccess(x interface{}) {
	p.Success = x.(*EditTripResponse)
}

var fieldIDToName_TripServiceEditTripResult = map[int16]string{
	0: "success",
}

func (p *TripServiceEditTripResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *TripServiceEditTripResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TripServiceEditTripResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TripServiceEditTripResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewEditTripResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *TripServiceEditTripResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("EditTrip_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *TripServiceEditTripResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *TripServiceEditTripResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TripServiceEditTripResult(%+v)", *p)
}

func (p *TripServiceEditTripResult) DeepEqual(ano *TripServiceEditTripResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *TripServiceEditTripResult) Field0DeepEqual(src *EditTripResponse) bool {
