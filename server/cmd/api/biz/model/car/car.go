...
type Location struct {
	...
	Longtitude float64 `thrift:"longtitude,2" form:"longtitude" json:"longtitude" query:"longtitude"`
}
...
type Car struct {
	...
	Drivar   *Driver   `thrift:"drivar,2" form:"drivar" json:"drivar" query:"drivar"`
...
type GetCarsResponse struct {
	Cars []*CarEntity `thrift:"cars,1" form:"cars" json:"cars" query:"cars"`
}
...
type CarServiceCreateCarArgs struct {
	Req *CreateCarRequest `thrift:"req,1"`
}
...
type CarServiceCreateCarResult struct {
	Success *CarEntity `thrift:"success,0,optional"`
}
...
type CarServiceGetCarResult struct {
	Success *Car `thrift:"success,0,optional"`
}
...
type CarServiceLockCarArgs struct {
	Req *LockCarRequest `thrift:"req,1"`
}
...
type CarServiceLockCarResult struct {
	Success *LockCarResponse `thrift:"success,0,optional"`
}
...
type CarServiceUnlockCarArgs struct {
	Req *UnlockCarRequest `thrift:"req,1"`
}
...
type CarServiceUpdateCarArgs struct {
	Req *UpdateCarRequest `thrift:"req,1"`
}
